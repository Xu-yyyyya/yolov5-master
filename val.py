...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/ccpd_datasets.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp32/weights/best.pt', help='model.pt path(s)')
